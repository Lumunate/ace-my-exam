  ...
  return (
    <Grid container rowSpacing={'17px'} columnSpacing={'24px'} sx={{ mb: '40px'}} columns={12}>
      ...
      >
        ...
        >
          <Box sx={{ display: 'flex', alignItems: 'center' }}>
            <Image src={resourceTypes.revisionNotes.icon} alt={resourceTypes.revisionNotes.name} width={25} height={25} />
      ...
      >
        ...
        >
          <Box sx={{ display: 'flex', alignItems: 'center' }}>
            <Image src={resourceTypes.topicalQuestions.icon} alt={resourceTypes.topicalQuestions.name} width={25} height={25} />
            <ResourcesCardTypography variant="body1" sx={{ ml: '12px', textWrap: 'nowrap' }}>
      ...
      >
        ...
        >
          <Box sx={{ display: 'flex', alignItems: 'center' }}>
            <Image src={resourceTypes.pastPapers.icon} alt={resourceTypes.pastPapers.name} width={25} height={25} />
            <ResourcesCardTypography variant="body1" sx={{ ml: '12px', textWrap: 'nowrap' }}>
