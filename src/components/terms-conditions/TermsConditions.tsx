  ...
  return (
    <TermsConditionsContainer>
      ...
      <Typography variant="body1" gutterBottom>
        ...
        The law says that someone is a consumer for these purposes when they are
        buying something which isn’t for their “trade, business, craft or
        profession”. If you have this legal right (i.e. you are a consumer and
        you are buying at a distance), then you usually have 14 days from the
        date after you place your order to cancel the order. However, if you use
        any services, then you will have to pay for what you’ve received.
      </Typography>
      <Typography variant="body1" gutterBottom>
      ...
      <Typography variant="body1" gutterBottom>
      <span style={{fontWeight:'bold'}}>(1) Limitation of liability</span>: In so far as the law allows, we will never
        be liable for any indirect, incidental or consequential loss or damage,
        including any economic loss or loss of profit or business whatsoever
        suffered by you or anyone else, however it was caused. If we are found
        liable in any way, then your claim would be limited to damages which
        will not exceed the amount you paid for, as applicable, the invoice to
      ...
      <Typography variant="body1" gutterBottom>
      <span style={{fontWeight:'bold'}}>(3) Notices</span>: Notices must be sent to the email and/or postal addresses
        provided in the Tuition Requirement Email unless we write to with a
        change, or you email us to contact@acemyexam.co.uk. Notices are deemed
        to be received when sent by:
      </Typography>
      <Typography variant="body1" gutterBottom>
      ...
      <Typography variant="body1" gutterBottom>
      <span style={{fontWeight:'bold'}}>(4) Waiver</span>: Nothing in our Agreement will stop us from enforcing any of
        our rights in the future.
      </Typography>
      <Typography variant="body1" gutterBottom>
      <span style={{fontWeight:'bold'}}>(5) Invalidity</span>: Each section (clause) or any part at all of our
      ...
      <Typography variant="body1" gutterBottom>
        <span style={{fontWeight:'bold'}}>(6) Governing Law</span>: Our Agreement will be interpreted, construed and
