  ...
  return (
    <ReschedulingPolicyContainer>
      ...
      <Typography variant='body1' gutterBottom>
        ...
        <span style={{ fontWeight: 'bold' }}>Tuition Confirmation</span>. As an
        Employment Business, you can also contact us directly by emailing{' '}
        <Link
      ...
      <Typography variant='body1' gutterBottom>
        (ii) A Client must give the Tutor{' '}
        <span style={{ fontWeight: 'bold' }}>at least 24 hours’ notice</span> so
        they are not charged for that session.{' '}
        <span style={{ fontWeight: 'bold' }}>
          Prepaid sessions will be rescheduled.
        </span>
      </Typography>
      <Typography variant='body1' gutterBottom>
      ...
      <Typography variant='body1' gutterBottom>
        (c)<span style={{ fontWeight: 'bold' }}> Group Sessions</span> – Group
        Sessions can’t usually be rescheduled, but if a Client misses a session,
        they may be able to participate in a substituted session, but we are
        unable to guarantee this. Please email{' '}
        <Link
          href='mailto:contact@acemyexam.co.uk'
          sx={{
            color: theme.palette.accent.main,
      ...
      <Typography variant='body1' gutterBottom>
        ...
        <span style={{ fontWeight: 'bold' }}>no later than 5 minutes</span>{' '}
