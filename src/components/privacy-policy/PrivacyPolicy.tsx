...
import { Heading, PrivacyPolicyContainer } from './PrivacyPolicy.style';
  ...
  return (
    <PrivacyPolicyContainer>
      ...
      >
        ...
        personal data collected through our tuition services and any employment
        agency activities. If you have any questions or concerns regarding the
        processing of your personal data, please contact us using the details
      ...
      <Typography
        ...
        sx={{ marginBottom: '1rem', paddingLeft: '2rem' }}
      >
        1. We process personal data based on one or more of the following legal
        bases:
      </Typography>
      <Typography
        variant='body1'
      ...
      <Typography
        ...
        sx={{ marginBottom: '1rem', paddingLeft: '4rem' }}
      >
        4. Consent: Processing is based on your consent, which you may withdraw
        at any time.
      </Typography>
      ...
      >
        ...
        performance) to tailor tuition sessions to individual student needs and
        monitor progress.
      </Typography>
      <Typography
        variant='body1'
        sx={{ marginBottom: '1rem', paddingLeft: '4rem' }}
      >
        3. Tutor information (such as qualifications, experience, and feedback)
        to assess suitability, allocate appropriate tutors for tuition sessions,
        and facilitate employment agency introductions.
      </Typography>
      ...
      >
        ...
        agency introductions, subject to consent and agreement between parties.
        We will never share client information with another client without the
      ...
      >
        ...
        assist us in providing tuition services or introductions to tutors, such
        as IT service providers, payment processors, and administrative support.
      </Typography>
      <Typography
        variant='body1'
        sx={{ marginBottom: '1rem', paddingLeft: '4rem' }}
      >
        ...
        authorities or law enforcement agencies as required by law or to protect
        our legal rights.
      </Typography>
      <Typography
        variant='body1'
      ...
      <Typography
        ...
        sx={{ marginBottom: '1rem', paddingLeft: '2rem' }}
      >
        1. We retain personal information for as long as necessary to fulfil the
        purposes for which it was collected, including any legal, accounting, or
        reporting requirements. The specific retention period for personal data
        may vary depending on the nature of the data and the purposes for which
        it is processed.
      </Typography>
      ...
      <Typography
        ...
        sx={{ marginBottom: '1rem', paddingLeft: '4rem' }}
      >
        2. Right to Rectification: You have the right to request the correction
      ...
      <Typography
        ...
        sx={{ marginBottom: '1rem', paddingLeft: '4rem' }}
      >
        3. Right to Erasure: You have the right to request the deletion of your
      ...
      >
        ...
        your personal data under certain circumstances, including processing for
      ...
      <Typography
        ...
        sx={{ marginBottom: '1rem', paddingLeft: '2rem' }}
      >
        2. Special category data and data relating to children (under the age of
        18) and vulnerable adults (“Sensitive Data”) that is collected and
        processed in accordance with this policy shall be stored subject to
        additional reviews by our internal team to ensure that we are satisfied
        that the storage and processing of that data is appropriate. In
        particular, Sensitive Data shall be subject to the following additional
        safeguards:
      </Typography>
      <Typography
        variant='body1'
      ...
      >
        ...
        least every three (3) months to ensure that it is appropriately secured
        and protected.
      </Typography>
      <Typography
        variant='body1'
      ...
      >
        1. Who can access Sensitive Data, and how much access they will need at
        any given point in time in order to discharge our duties to you or to
      ...
      >
        ...
        including guidelines about what copies might be made, what they will be
        used for and where they will be stored.
      </Typography>
      <Typography
        variant='body1'
        sx={{ marginBottom: '1rem', paddingLeft: '2rem' }}
      >
        3. In the event that there was to be any data breach of any kind (either
        suspected or known), we will undertake to:
      </Typography>
      <Typography
        variant='body1'
        sx={{ marginBottom: '1rem', paddingLeft: '4rem' }}
      >
        1. Immediately take action to assess and mitigate the extent of any such
        breach.
      </Typography>
      <Typography
        variant='body1'
      ...
      <Typography
        ...
        sx={{ marginBottom: '1rem', paddingLeft: '4rem' }}
      >
        3. Inform data subjects of the data breach, using clear and jargon- free
        language.
      </Typography>
      <Typography
        variant='body1'
      ...
      <Typography
        ...
        sx={{ marginBottom: '1rem', paddingLeft: '4rem' }}
      >
        5. Where appropriate, we will keep data subjects informed of any change
        to the level of risk we assess exists as a result of any such breach.
      </Typography>
      ...
      >
        ...
        Privacy Policy on our website. We encourage you to review this Privacy
      ...
      >
        ...
        our data practices, or if you wish to exercise your data subject rights,
