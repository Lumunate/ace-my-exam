  ...
  return (
    ...
    >
      ...
      <List sx={{ padding:'0 auto', listStyleType: 'decimal', pl: 4 }}>
        ...
        <ListItem sx={{ padding:'0',display: 'list-item' }}>
          <ListItemText sx={{ padding:'0',}}>
            <strong>Accessing Tutoring:</strong>
          </ListItemText>
          <List sx={{ padding:'0 auto', listStyleType: 'lower-alpha', pl: 4 }}>
            <ListItem sx={{ padding:'0',display: 'list-item' }}>
              <ListItemText sx={{ padding:'0',}}>
        ...
        <ListItem sx={{ padding:'0',display: 'list-item' }}>
          <ListItemText sx={{ padding:'0',}}>
            Your Information, Data Protection and Confidentiality:
          </ListItemText>
          <List sx={{ padding:'0 auto', listStyleType: 'lower-alpha', pl: 4 }}>
            <ListItem sx={{ padding:'0',display: 'list-item' }}>
              <ListItemText sx={{ padding:'0',}}>
      ...
      <List sx={{ padding:'0 auto', listStyleType: 'decimal', pl: 4 }}>
        <ListItem sx={{ padding:'0',display: 'list-item' }}>
          <ListItemText sx={{ padding:'0',}}>
            <strong>Cancellations</strong> – Subject to any tuition packages,
        ...
        <ListItem sx={{ padding:'0',display: 'list-item' }}>
          <ListItemText sx={{ padding:'0',}}>
            <strong>Consumer Cancellations</strong>: The law gives consumers who
      ...
      <List sx={{ padding:'0 auto', listStyleType: 'decimal', pl: 4 }}>
        ...
        <ListItem sx={{ padding:'0',display: 'list-item' }}>
          <ListItemText sx={{ padding:'0',}}>
            <strong>Paying</strong>: Payment must be made within 5 days of the
        ...
        <ListItem sx={{ padding:'0',display: 'list-item' }}>
          <ListItemText sx={{ padding:'0',}}>
            <strong>Minimum term</strong> – Sometimes sessions are scheduled for
        ...
        <ListItem sx={{ padding:'0',display: 'list-item' }}>
          <ListItemText sx={{ padding:'0',}}>
            <strong>Offers</strong>: Any offers which we may make available
        ...
        <ListItem sx={{ padding:'0',display: 'list-item' }}>
          <ListItemText sx={{ padding:'0',}}>
            <strong>Extras</strong>: You will have to pay extra if you ask for
        ...
        <ListItem sx={{ padding:'0',display: 'list-item' }}>
          <ListItemText sx={{ padding:'0',}}>
            <strong>Payment Problems</strong>: If there’s a problem with
      ...
      <List sx={{ padding:'0 auto', listStyleType: 'decimal', pl: 4 }}>
        <ListItem sx={{ padding:'0',display: 'list-item' }}>
          <ListItemText sx={{ padding:'0',}}>
            <strong>Limitation of liability</strong>: In so far as the law
        ...
        <ListItem sx={{ padding:'0',display: 'list-item' }}>
          <ListItemText sx={{ padding:'0',}}>
            <strong>Notices</strong>: Notices must be sent to the email and/or
        ...
        <ListItem sx={{ padding:'0',display: 'list-item' }}>
          <ListItemText sx={{ padding:'0',}}>
            <strong>Waiver</strong>: Nothing in our Agreement will stop us from
            enforcing any of our rights in the future.
          </ListItemText>
        </ListItem>
        <ListItem sx={{ padding:'0',display: 'list-item' }}>
          <ListItemText sx={{ padding:'0',}}>
            <strong>Invalidity</strong>: Each section (clause) or any part at
        ...
        <ListItem sx={{ padding:'0',display: 'list-item' }}>
          <ListItemText sx={{ padding:'0',}}>
            <strong>Governing Law</strong>: Our Agreement will be interpreted,
