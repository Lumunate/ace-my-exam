...
const page = () => {
  return (
    ...
    >
      ...
      <Typography variant='h3' gutterBottom sx={{ marginBottom: '32px', color: 'black' }}>
      ...
      <List sx={{ padding: '0', listStyleType: 'disc', pl: 4 }}>
        ...
        <ListItem sx={{ padding: '0', display: 'list-item' }}>
          <ListItemText sx={{ padding: '0', marginBottom: '4px', color: 'grey' }}>Storing child protection records</ListItemText>
        </ListItem>
        <ListItem sx={{ padding: '0', display: 'list-item' }}>
          <ListItemText sx={{ padding: '0', marginBottom: '4px', color: 'grey' }}>
        ...
        <ListItem sx={{ padding: '0', display: 'list-item' }}>
          <ListItemText sx={{ padding: '0', marginBottom: '4px', color: 'grey' }}>Keeping children safe online</ListItemText>
        </ListItem>
        <ListItem sx={{ padding: '0', display: 'list-item' }}>
          <ListItemText sx={{ padding: '0', marginBottom: '4px', color: 'grey' }}>Whistleblowing and complaints</ListItemText>
        </ListItem>
      </List>
      <Typography variant='body1' sx={{ marginBottom: '16px', color: 'grey' }}>
        We recognise that:
      ...
      <List sx={{ padding: '0', listStyleType: 'disc', pl: 4 }}>
        <ListItem sx={{ padding: '0', display: 'list-item' }}>
          <ListItemText sx={{ padding: '0', marginBottom: '4px', color: 'grey' }}>Name: Asma Chaudhri</ListItemText>
        </ListItem>
        <ListItem sx={{ padding: '0', display: 'list-item' }}>
          <ListItemText sx={{ padding: '0', marginBottom: '4px', color: 'grey' }}>Role: Owner and Lead Tutor</ListItemText>
        </ListItem>
        <ListItem sx={{ padding: '0', display: 'list-item' }}>
          <ListItemText sx={{ padding: '0', marginBottom: '4px', color: 'grey' }}>Phone: 0737 9065363</ListItemText>
        </ListItem>
        <ListItem sx={{ padding: '0', display: 'list-item' }}>
          <ListItemText sx={{ padding: '0', marginBottom: '4px', color: 'grey' }}>
            Email:{' '}
      ...
      <List sx={{ padding: '0', listStyleType: 'decimal', pl: 4 }}>
        ...
        <ListItem sx={{ padding: '0', display: 'list-item' }}>
          <ListItemText sx={{ padding: '0', marginBottom: '4px', color: 'grey' }}>the police.</ListItemText>
        </ListItem>
        <ListItem sx={{ padding: '0', display: 'list-item' }}>
          <ListItemText sx={{ padding: '0', marginBottom: '4px', color: 'grey' }}>
