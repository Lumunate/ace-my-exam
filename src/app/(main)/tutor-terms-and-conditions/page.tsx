...
const page = () => {
  return (
    ...
    >
      ...
      {/* Updated Date */}
      <Typography variant="body1" sx={{marginBottom:'1rem', padding:'0', fontStyle: 'italic'}}>
      ...
      <List sx={{padding:'0 auto', listStyleType: 'decimal', pl: 4 }}>
        <ListItem sx={{padding:'0 ', display: 'list-item', pb: 0 }}>
          <ListItemText sx={{ padding:'0' }} primary={
            <Typography variant="body1" sx={{marginBottom:'1rem', padding:'0'}}>
        ...
        <ListItem sx={{padding:'0 ', display: 'list-item', pb: 0 }}>
          <ListItemText sx={{ padding:'0' }} primary={
            <Typography variant="body1" sx={{marginBottom:'1rem', padding:'0'}}>
              <strong>Contact:</strong> We will each use the contact details provided in the Key Information Document.
            </Typography>
          } />
        </ListItem>
        <ListItem sx={{padding:'0 ', display: 'list-item', pb: 0 }}>
      ...
      <List sx={{padding:'0 auto', listStyleType: 'decimal', pl: 4 }}>
        ...
        <List sx={{padding:'0 auto', listStyleType: 'lower-alpha', pl: 4 }}>
          ...
          <ListItem sx={{padding:'0 ', display: 'list-item', pb: 0 }}>
            <ListItemText sx={{ padding:'0' }} primary={
              <Typography variant="body1" sx={{marginBottom:'1rem', padding:'0'}}>
                <strong>No mutuality of obligation</strong> – We are not obliged to offer, and you are not obliged to accept, any Tutor Assignment. For the avoidance of doubt, we both agree and intend that we do not create any mutuality of obligation at any time.
              </Typography>
            } />
          </ListItem>
        </List>
        ...
        <ListItem sx={{padding:'0 ', display: 'list-item', pb: 0 }}>
          <ListItemText sx={{ padding:'0' }} primary={
            <Typography variant="body1" sx={{marginBottom:'1rem', padding:'0'}}>
              <strong>Providing Training</strong> Online Sessions – You will be provided with an account on Tutor Cruncher. This will enable you to schedule sessions
            </Typography>
          } />
        </ListItem>
        <List sx={{padding:'0 auto', listStyleType: 'lower-alpha', pl: 4 }}>
      ...
      <List sx={{padding:'0 auto', listStyleType: 'decimal', pl: 4 }}>
        ...
        <ListItem sx={{padding:'0 ', display: 'list-item', pb: 0 }}>
          <ListItemText sx={{ padding:'0' }} primary={
            <Typography variant="body1" sx={{marginBottom:'1rem', padding:'0'}}>
              We will usually pay each accepted invoice within 14 days of the date of the invoice <strong><i>by Bank Transfer</i></strong>. In accordance with the Legislation you will be paid for tuition services you have provided, irrespective of whether the Client has paid us.
            </Typography>
          } />
        </ListItem>
      </List>
      ...
      <List sx={{padding:'0 auto', listStyleType: 'decimal', pl: 4 }}>
        ...
        <List sx={{padding:'0 auto', listStyleType: 'lower-alpha', pl: 4 }}>
          ...
          <ListItem sx={{padding:'0 ', display: 'list-item', pb: 0 }}>
            <ListItemText sx={{ padding:'0' }} primary={
              <Typography variant="body1" sx={{marginBottom:'1rem', padding:'0'}}>
                Where any incident occurs which, you reasonably anticipate is likely to be the subject of a complaint or any Client raises any complaint directly with you, then you agree to email us at with full details within <strong><i>1 working day</i></strong> of you becoming aware of the issue/complaint.
              </Typography>
            } />
          </ListItem>
          <ListItem sx={{padding:'0 ', display: 'list-item', pb: 0 }}>
        ...
        <ListItem sx={{padding:'0 ', display: 'list-item', pb: 0 }}>
          <ListItemText sx={{ padding:'0' }} primary={
            <Typography variant="body1" sx={{marginBottom:'1rem', padding:'0'}}>
              <strong>Confidentiality and Data Protection</strong> – Unless required to by law you agree to keep all information relating to any Client and/or Tutor Assignment confidential and only use it to provide tuition services to that relevant Client.
            </Typography>
          } />
        </ListItem>
        <List sx={{padding:'0 auto', listStyleType: 'lower-alpha', pl: 4 }}>
      ...
      <List sx={{padding:'0 auto', listStyleType: 'decimal', pl: 4 }}>
        ...
        <ListItem sx={{padding:'0 ', display: 'list-item', pb: 0 }}>
          <ListItemText sx={{ padding:'0' }} primary={
            <Typography variant="body1" sx={{marginBottom:'1rem', padding:'0'}}>
              <strong>No partnership</strong> – You agree that nothing in our Agreement will be deemed to create any partnership, joint venture or other agency relationship between us. Neither of us will
            </Typography>
          } />
        </ListItem>
        <ListItem sx={{padding:'0 ', display: 'list-item', pb: 0 }}>
          <ListItemText sx={{ padding:'0' }} primary={
            <Typography variant="body1" sx={{marginBottom:'1rem', padding:'0'}}>
              <strong>Notices</strong>: Notices must be sent to the email and/or postal addresses provided in the <strong><i>Tuition Assignment</i></strong> unless we write to with a change, or you email us to contact@acemyexam.co.uk. Notices are deemed to be received when sent by :-
            </Typography>
          } />
        </ListItem>
        <List sx={{padding:'0 auto', listStyleType: 'lower-alpha', pl: 4 }}>
        ...
        <ListItem sx={{padding:'0 ', display: 'list-item', pb: 0 }}>
          <ListItemText sx={{ padding:'0' }} primary={
            <Typography variant="body1" sx={{marginBottom:'1rem', padding:'0'}}>
              <strong>Force Majeure</strong> – Neither of us will be liable for any delay or failure to perform any of our obligations if the delay or failure results from events or circumstances outside our reasonable control including, but not limited to, acts of God, pandemic, accidents, war, fire, strikes, communications failure (including telecommunications or computer), breakdown of plant or machinery or shortage or unavailability of raw materials from a natural source of supply, and are entitled to a reasonable extension of our obligations.
            </Typography>
          } />
        </ListItem>
        <ListItem sx={{padding:'0 ', display: 'list-item', pb: 0 }}>
          <ListItemText sx={{ padding:'0' }} primary={
            <Typography variant="body1" sx={{marginBottom:'1rem', padding:'0'}}>
              <strong>Waiver</strong>: Nothing in our Agreement will stop us from enforcing any of our rights in the future.
            </Typography>
          } />
        </ListItem>
        <ListItem sx={{padding:'0 ', display: 'list-item', pb: 0 }}>
          <ListItemText sx={{ padding:'0' }} primary={
            <Typography variant="body1" sx={{marginBottom:'1rem', padding:'0'}}>
              <strong>Invalidity</strong>: Each section (clause) or any part at all of our Agreement is to be regarded as independent of the others. This means that if any clause or any part at all of our Agreement is found to be unenforceable or invalid, it will be treated as being cut out (severed) and will not affect the enforceability or validity of the rest of our Agreement.
            </Typography>
          } />
        </ListItem>
        <ListItem sx={{padding:'0 ', display: 'list-item', pb: 0 }}>
          <ListItemText sx={{ padding:'0' }} primary={
            <Typography variant="body1" sx={{marginBottom:'1rem', padding:'0'}}>
              <strong>Governing Law</strong>: Our Agreement will be interpreted, construed and enforced in accordance with English law and will be subject to the exclusive power (jurisdiction) of the English Courts.
            </Typography>
          } />
        </ListItem>
      </List>
